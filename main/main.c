                                 ...
                                 void *arg)
{
    ...
    switch (event) {
        ...
        case HID_HOST_INTERFACE_EVENT_DISCONNECTED:
            ...
            pax_simple_rect(&fb, WHITE, 0, 0, pax_buf_get_width(&fb), 72);
            snprintf(text, sizeof(text), "HID Device, protocol '%s' DISCONNECTED", hid_proto_name_str[dev_params.proto]);
            pax_draw_text(&fb, BLACK, pax_font_sky_mono, 16, 0, 18, text);
            blit();
        ...
        case HID_HOST_INTERFACE_EVENT_TRANSFER_ERROR:
            ...
            pax_simple_rect(&fb, WHITE, 0, 0, pax_buf_get_width(&fb), 72);
            snprintf(text, sizeof(text), "HID Device, protocol '%s' TRANSFER_ERROR", hid_proto_name_str[dev_params.proto]);
            pax_draw_text(&fb, BLACK, pax_font_sky_mono, 16, 0, 18, text);
            blit();
        ...
        default:
            ...
            pax_simple_rect(&fb, WHITE, 0, 0, pax_buf_get_width(&fb), 72);
            snprintf(text, sizeof(text), "HID Device, protocol '%s' Unhandled event", hid_proto_name_str[dev_params.proto]);
            pax_draw_text(&fb, BLACK, pax_font_sky_mono, 16, 0, 18, text);
            blit();
